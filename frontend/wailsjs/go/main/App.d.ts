...
export function ApplyCulling(arg1:boolean):Promise<main.CullingApplyResult>;
...
export function ListCullingPhotos():Promise<main.CullingListResult>;

export function MarkPhoto(arg1:string,arg2:string):Promise<void>;
